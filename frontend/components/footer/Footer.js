...
import logo from "../../public/assets/iconFooter.png";
import Image from "next/image";

export default function Footer({ session }) {
  return (
    <footer className="p-[0_20px_20px_20px] bg-white dark:bg-gray-900">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                  ...
                  <li>
                    <Link href="/team" className="hover:underline">Sobre Nosotros</Link>
                  </li>
                </ul>
              </div>
              <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Siguenos</h2>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium">
                    <li className="mb-4">
                      <Link href="https://github.com/Mundo-Gym/Mundo-Gym" className="hover:underline ">Github</Link>
